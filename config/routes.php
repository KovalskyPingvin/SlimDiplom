...
return function ($app) {
    ...
    $app->get('/requests', \App\Controllers\User\Actions\RequestsUserAction::class)
        ->add(\App\Middleware\UserAuthMiddleware::class); // ← Только авторизация
    ...
    $app->group('/admin', function (RouteCollectorProxy $group) {
        ...
        $group->post('/requests/complete', \App\Controllers\Admin\Actions\RequestsCompleteAction::class);
    })->add(\App\Middleware\AuthMiddleware::class); // ← Только админы
};