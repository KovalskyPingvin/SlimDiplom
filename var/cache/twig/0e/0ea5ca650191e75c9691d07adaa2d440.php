...
class __TwigTemplate_b1ae0266f13dd47540cd0f199059e343 extends Template
{
...
{% block content %}
<div class=\"compatibility-page\">  <!-- ← Оборачиваем в div с классом -->
    <div class=\"content-wrapper\">
        <h1 class=\"h1-comp\">Совместимость картриджей и принтеров</h1>
...
</div>  <!-- ← Закрывающий div для .compatibility-page -->
<script src=\"/js/admin/compatibility.js\"></script>
{% endblock %}", "admin/compatibility.twig", "D:\\OSPanel\\domains\\slimdiplom\\templates\\admin\\compatibility.twig");
    }
}
